...
// make each class return a vector with comp as index 0 and swap as index 1
// fix bubble and merge sort comp and swap counters
// make them actually write into the .csv files
// calculate averages for runtime, comps, and swaps and write to .csv file
// turn .csv files into excel spreadsheets
